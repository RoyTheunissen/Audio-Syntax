...
>
> Please see [the wiki](https://github.com/RoyTheunissen/Audio-Syntax/wiki/FMOD-Syntax#migrating-from-the-original-fmod-syntax-package-to-audio-syntax) for more information.
...
```
openupm add com.roytheunissen.audiosyntax
```
